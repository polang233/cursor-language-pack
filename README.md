...
| Locale | Status |
| --- | --- |
| `zh-cn` 简体中文 | Shipped — workbench 99.8% plus all 1750 Cursor-specific core keys (100%) |
...
Reconciled against Cursor **3.19.13** (Code OSS 1.128.0), **3.17.21**, and **3.16.17**. Other builds usually work; new strings stay English until someone runs `npm run check-upgrade`.
