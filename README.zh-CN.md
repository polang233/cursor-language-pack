...
| 语言 | 状态 |
| --- | --- |
| `zh-cn` 简体中文 | 已发布 — 工作台 99.8% + Cursor 自有 NLS 1750 键（100%） |
...
已对齐 Cursor **3.19.13**（Code OSS 1.128.0）、**3.17.21** 与 **3.16.17**。其他版本一般能用；之后新增的字符串会先显示英文，直到有人跑 `npm run check-upgrade` 并补译文。
