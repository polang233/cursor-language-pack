...
- 编辑器主体（底座来自 [microsoft/vscode-loc](https://github.com/microsoft/vscode-loc)，钉在 Code OSS 1.128，对齐 Cursor 3.19.13）
...
已对齐 Cursor **3.19.13**、**3.17.21** 与 **3.16.17**。其他版本一般能用，新增字符串会先显示英文。界面语言和 AI 回复语言无关。
